...
function jsScroll(obj, w)
{
    ...
    document.getElementById('main_relative').appendChild(obj.scrollBar);
    ...
    obj.scrollBar.className = 'scrollBar';
    obj.scrollBar.id = 'scrollBar';
    obj.scrollBarIndex.className = 'scrollBarIndex';
    // if(!className) {
    // 	obj.scrollBar.style.backgroundColor = 'rgba(169,134,113,0.1)';
